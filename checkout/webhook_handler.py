# This is a copy of code provided by Code Institute
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.default_address_line_1 = shipping_details.address.line2
                profile.save()
        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    first__name_iexact=shipping_details.first.name,
                    last_name__iexact=shipping_details.last.name,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    first__name=shipping_details.first.name,
                    last_name=shipping_details.last.name,
